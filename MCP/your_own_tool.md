...
Here we provide you with several ideas to gain more experience with building your own MCP. Specifically, we discuss three options:
1. Extend the MCP that we discuss in the [Quickstart](quickstart.md).
